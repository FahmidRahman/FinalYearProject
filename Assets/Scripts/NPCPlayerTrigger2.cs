...
public class NPCPlayerTrigger2 : MonoBehaviour
{
    ...
    [Header("Thank You Panel")] // ✅ New header
    public GameObject thankYouPanel; // ✅ Drag your thank-you panel here

    [Header("Special Positions")]
    public Transform exitPoint;
    private Vector2 dynamicDialoguePosition;
    ...
    void Start()
    {
        ...
        if (thankYouPanel != null) // ✅ Hide it at start
        {
    ...
    void EndDialogue()
    {
        ...
        if (thankYouPanel != null) // ✅ Show thank-you panel at the end
        {
            thankYouPanel.SetActive(true);
        }

        StartCoroutine(UnfreezePlayerAfterDelay(2.5f));
